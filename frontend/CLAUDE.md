...
React.js application for Application de gestion des taches, avec inscription et connection, gestion du profil, gestion des listes de taches avec lien d'invitation à une liste pour d'autres utilisateurs, multilangues, thème dark et light
